...
DometicCfxBleSensor = dometic_cfx_ble_ns.class_(
    "DometicCfxBleSensor", esphome_sensor.Sensor, cg.PollingComponent
)

CONFIG_SCHEMA = esphome_sensor.sensor_schema(DometicCfxBleSensor).extend({
